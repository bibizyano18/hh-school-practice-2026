...
(0, _jqueryDefault.default)(document).ready(function() {
    (0, _jqueryDefault.default)(".order-background").hide();
    let productName = "";
    let productPrice = "";
    let isValid = true;
    let errors = [];
    (0, _jqueryDefault.default)(".card__button").click(function(e) {
        (0, _jqueryDefault.default)(".order-background").fadeIn(300);
        (0, _jqueryDefault.default)("body").css("overflow", "hidden");
        let $card = (0, _jqueryDefault.default)(this).closest(".card");
        productName = $card.find(".card__title").text();
        productPrice = $card.find(".card__price").text();
    });
    (0, _jqueryDefault.default)("form").submit(function(e) {
        e.preventDefault();
        errors = [];
        isValid = true;
        let fio = (0, _jqueryDefault.default)('input[name="fio"]').val();
        let email = (0, _jqueryDefault.default)('input[name="email"]').val();
        let deliveryType = (0, _jqueryDefault.default)('input[name="deliveryType"]:checked').val();
        let city = (0, _jqueryDefault.default)('select[name="city"]').val();
        if (!deliveryType) {
            isValid = false;
    ...
    (0, _jqueryDefault.default)(".order-background").click(function(e) {
        if ((0, _jqueryDefault.default)(e.target).hasClass("order-background")) closeModal();
    });
    function closeModal() {
        (0, _jqueryDefault.default)(".order-background").fadeOut(300);
        (0, _jqueryDefault.default)("body").css("overflow", "");
    }
});
...
},{}]},["3smKr","bB7Pu"], "bB7Pu", "parcelRequire9fe2")
